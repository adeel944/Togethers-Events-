...
export interface Invoice {
  id: string;
  invoiceNumber: string; // e.g. "TE-0001"
  documentTitle?: string; // e.g. "BOOKING CONFIRMATION"
  bookingId?: string;
  clientId: string;
  clientName: string;
  clientPhone: string;
  ...
  templateId: string; // 'classic' | 'minimal' | 'modern' | 'clean' | 'professional' | 'elegant' | 'compact' | 'corporate' | 'simple-lines' | 'premium-minimal'
  createdAt: string;
}
