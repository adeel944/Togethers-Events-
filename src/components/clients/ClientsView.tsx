...
import { Plus, Search, Users, Phone, Mail, MapPin, Edit2, Trash2, CalendarCheck2 } from 'lucide-react';
import { Client, Booking, BusinessProfile } from '../../types';
...
interface ClientsViewProps {
  clients?: Client[]; bookings?: Booking[]; profile?: BusinessProfile;
...
export const ClientsView: React.FC<ClientsViewProps> = ({ clients: inputClients = [], bookings: inputBookings = [], profile: inputProfile, onCreateClient, onUpdateClient, onDeleteClient, onSelectBooking }) => {
